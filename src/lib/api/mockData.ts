...
import { Room, Event, Course } from './types';
...
export const mockRooms: Room[] = [
  ...
  },
  {
    ...
    capacity: 30,
    features: ['Computers', 'Specialized Equipment'],
    status: 'maintenance',
  },
  {
    id: 'room-005',
...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    description: 'Annual event for student organizations to recruit new members',
  ...
  {
    id: 'evt-003',
    title: 'Research Presentation: AI Ethics',
    description: 'Guest lecture on ethical considerations in AI development',
    startDate: new Date(Date.now() + 43200000).toISOString(), // Later today
    endDate: new Date(Date.now() + 43200000 + 5400000).toISOString(),
    roomId: 'room-003',
  ...
  },
  {
    ...
    description: 'Networking opportunity for recent graduates',
  ...
  {
    id: 'evt-005',
    title: 'Thesis Defense: Jane Smith',
    description: 'PhD thesis defense on renewable energy systems',
  ...
  },
  {
    ...
    endDate: new Date(Date.now() + 518400000 + 14400000).toISOString(),
    roomId: 'room-008',
...
// Filter functions
export function filterRooms(filters: { status?: string; building?: string; room?: string; query?: string }): Room[] {
...
export function filterEvents(filters: { status?: string; room?: string; building?: string; query?: string }): Event[] {
...
export function filterCourses(filters: { status?: string; room?: string; building?: string; query?: string }): Course[] {
